<%@ page language="C#" autoeventwireup="true" inherits="User_Message_MessageGarbagebox, App_Web_jitizdai" enableviewstatemac="false" enableEventValidation="false" viewStateEncryptionMode="Never" %>
<!DOCTYPE HTML>
<html>
<head runat="server">
<title>垃圾箱</title>
...
<div class="us_seta" style="margin-top: 5px;">
    ...
    <asp:Button ID="Button3" runat="server" Font-Size="9pt" Text="批量删除" OnClick="Button2_Click" class="btn btn-primary" />
</div>
</div>
</form>
</body>
