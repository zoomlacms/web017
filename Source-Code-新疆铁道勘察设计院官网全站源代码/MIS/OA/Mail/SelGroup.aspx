<%@ page language="C#" autoeventwireup="true" inherits="MIS_OA_Mail_SelGroup, App_Web_jitizdai" clientidmode="Static" enableEventValidation="false" viewStateEncryptionMode="Never" %>
...
<body>
<form id="form1" runat="server"><!--可多选用户组，点确认调用父节点方法完成赋值-->
    ...
    <div runat="server" id="AllInfo_Div" class="mainDiv">
       ...
       <div style="float:left;margin-left:10px;width:580px;top:2px;">
           <div style="margin-bottom: 5px;">
               ...
               <asp:Button runat="server" ID="showAll_Btn" Text="全部用户" CssClass="btn-primary" OnClick="showAll_Btn_Click" Height="34" />
        ...
        <ZL:ExGridView runat="server" ID="EGV" AutoGenerateColumns="false" AllowPaging="true" PageSize="10" EnableTheming="False"  CssClass="table border" EmptyDataText="当前没有信息!!"
                ...
                <Columns>
                    <asp:TemplateField>
                        <ItemTemplate>
                            <input type="checkbox" name="idChk" value="<%#Eval("UserID") %>" userInfo="<%#Eval("UserID")+":"+Eval("UserName") %>" />
    ...
    <script>
        ...
        {
            chk = $(obj).parent().find(":checkbox");
            for (var i = 0; i < chk.length; i++) {
                chk[i].checked = $(obj).parent().find(":checkbox")[0].checked;
            }
        }
        ...
        function AllInfo_sureF()
        {
            ...
            if ($chkArr.length < 1) { alert("你尚未选定用户!!!"); return; }
            else
            {
