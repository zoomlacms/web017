<%@ page title="" language="C#" masterpagefile="~/User/Default.master" autoeventwireup="true" inherits="User_Default, App_Web_yt1ox2yv" clientidmode="Static" enableEventValidation="false" viewStateEncryptionMode="Never" %>
...
<asp:Content runat="server" ContentPlaceHolderID="Content">
    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 padding0 user_div">
        ...
        <div class="col-lg-2 col-md-3 col-sm-3 col-xs-12">
            <div style="background:#CC9966" class="user_base">
                <a href="/CN/Nite/Content/ResumeManage.aspx">招聘简历</a>
            </div>
        </div>
        <div class="col-lg-2 col-md-3 col-sm-3 col-xs-12">
            <div style="background:#990000" class="user_base">
                <a href="<%=CustomerPageAction.customPath2 %>AddOn/ProjectsList.aspx">项目管理</a>
            </div>
        </div>
        <div class="col-lg-2 col-md-3 col-sm-3 col-xs-12">
            <div style="background:#999999" class="user_base">
                <a href="Survey/SurveyAll.aspx" target="_blank">问卷投票</a>
            </div>
        </div>
        <div class="col-lg-2 col-md-3 col-sm-3 col-xs-12">
