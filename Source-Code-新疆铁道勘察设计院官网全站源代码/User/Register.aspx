<%@ page language="C#" autoeventwireup="true" inherits="ZoomLa.WebSite.User.User_Register, App_Web_b1asexi2" enableviewstatemac="false" clientidmode="Static" enableEventValidation="false" viewStateEncryptionMode="Never" %>
...
<div class="logo">
<a href="javascript:;" title=""><img src="<%:Call.LogoUrl %>" /></a>
</div>
</div>--%>
                        ...
                        <asp:Literal ID="Literal1" runat="server"></asp:Literal>
                                ...
                                <li>
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-6 col-lg-6 col-md-6 col-xs-12 ">
                                            <asp:TextBox ID="TxtPassword" TextMode="Password" runat="server" CssClass="form-control" onfocus=" focusinput();" />
                                        </div>
                                        <div class="col-sm-4 col-lg-4 col-md-4 col-xs-12 padding0 ">
                                            <div id="valPass">
