<%@ page language="C#" autoeventwireup="true" inherits="User_Main, App_Web_v0ekm0ob" enableviewstatemac="false" enableEventValidation="false" viewStateEncryptionMode="Never" %>
<!DOCTYPE HTML>
<html>
<head runat="server">
...
function goforum_interaction3_13() {
    Load('CommunityLeft.aspx', 'UserZone/Default.aspx')
    Showtib(3);
}
...
<li title="IDC管理">
<span onmouseover="this.className='Span2'" onmouseout="this.className='Span1'">
<a href="/Plugins/Domain/Domname.aspx?Page=7" target="_blank"><img src="/App_Themes/UserThem/Images/ub7.gif"/></a></span>
<p onmouseover="this.className='Span2'" onmouseout="this.className='Span1'"><a style="color:#1C5F85;" href="/Plugins/Domain/Domname.aspx?Page=7" target="_blank">IDC管理</a></p>
</li>
