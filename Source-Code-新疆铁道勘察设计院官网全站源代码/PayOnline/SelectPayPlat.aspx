<%@ page language="C#" autoeventwireup="true" inherits="ZoomLa.WebSite.Shop.SelectPayPlat, App_Web_ibvjnb1e" enableviewstatemac="false" enableEventValidation="false" viewStateEncryptionMode="Never" %>
    ...
    <form id="form1" runat="server">
        <div class="panel panel-primary" style="width: 500px; margin: auto; margin-top: 40px;">
            ...
            <div class="panel-body">
                ...
                <asp:RegularExpressionValidator CssClass="tips" ID="RegularExpressionValidator1" runat="server" ControlToValidate="TxtvMoney" Display="Dynamic" ForeColor="Red" ErrorMessage="必须为整数"
