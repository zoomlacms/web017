<%@ page language="C#" autoeventwireup="true" inherits="Manage_User_CompetenceAdd, App_Web_ny25oum0" debug="true" enableEventValidation="false" viewStateEncryptionMode="Never" %>
    ...
    <div >
        <table class="border" cellspacing="1" cellpadding="0" width="100%" border="0" align="center">
            ...
            <tr class="tdbg" style="min-height:40px;">
                <td class="tdbgleft" align="right" style="width: 100px;"><strong>OA权限设置：</strong></td>
                <td>
                    <div class="checkdiv">
            ...
            <tr>
                <td align="center" class="tdbgleft" colspan="2" style="height: 40px">
                    <input type="button" onclick="check()" name="btnSave" class="C_input" value="保存权限设置" />&nbsp; &nbsp;&nbsp;
