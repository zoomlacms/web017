<%@ page language="C#" masterpagefile="~/Manage/I/Default.master" autoeventwireup="true" inherits="Manage_I_Content_Author, App_Web_kqqfcyzr" enableEventValidation="false" viewStateEncryptionMode="Never" %>
        ...
        <tr>
            ...
            <td rowspan="8" colspan="2">
                <table width="100%" border="0" cellpadding="2" cellspacing="1">
                    ...
                    <tr>
                        <td align="left">
                            <asp:TextBox ID="txtpic" runat="server" CssClass="form-control pull-left"></asp:TextBox><br />
                            ...
                            <asp:Button ID="Button1" CssClass="btn btn-default" style="display:inline" runat="server" OnClick="Button1_Click" Text="上传"  />
                        </td>
                    </tr>
                </table>
            </td>
