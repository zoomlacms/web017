<%@ page language="C#" masterpagefile="~/Manage/I/Default.master" autoeventwireup="true" inherits="manage_AddOn_Maps, App_Web_kqqfcyzr" clientidmode="Static" validaterequest="false" enableEventValidation="false" viewStateEncryptionMode="Never" %>
<asp:Content ContentPlaceHolderID="head" runat="Server">
    <title>地图管理</title>
</asp:Content>
<asp:Content ContentPlaceHolderID="Content" runat="Server">
    <div class="user_t">
        <asp:GridView RowStyle-HorizontalAlign="Center" ID="GridView1" DataKeyNames="mid" CssClass="table table-striped table-bordered table-hover"
            ...
            OnRowCommand="Lnk_Click" EmptyDataText="无相关信息！">
            <Columns>
    ...
    <span id="Fy" class="text-center center-block" style="text-align: center;" runat="server">
        共
        ...
        <asp:TextBox ID="txtPage" runat="server" AutoPostBack="true" CssClass="l_input" Width="22" Height="22" OnTextChanged="txtPage_TextChanged">20</asp:TextBox>
        条数据/页 转到第
