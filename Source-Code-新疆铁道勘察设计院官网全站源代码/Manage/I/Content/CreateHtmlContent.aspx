<%@ page language="C#" masterpagefile="~/Manage/I/Default.master" autoeventwireup="true" inherits="Manage_I_Content_CreateHtmlContent, App_Web_qefxfnve" clientidmode="Static" validaterequest="false" debug="true" enableEventValidation="false" viewStateEncryptionMode="Never" %>
    ...
    <div>
        ...
        <div class="tab-content">
            <div class="tab-pane active" id="Tab1">
                <table width="100%" border="0" cellpadding="0" cellspacing="1" class="table table-bordered table-hover" align="center" id="crt1" name="crt1">
                    <tr>
