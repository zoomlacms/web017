<%@ page language="C#" autoeventwireup="true" inherits="V_Content_EditContent, App_Web_oo4sanix" masterpagefile="~/Manage/I/Default.master" clientidmode="Static" validaterequest="false" enableEventValidation="false" viewStateEncryptionMode="Never" %>
            ...
            <div class="tab-pane active" id="ConInfo" >
                <table class="table table-bordered table_padding0" style="margin-bottom:0;">
                    <tr>
                        ...
                        <td>
                            <asp:TextBox ID="txtTitle" style="max-width:715px;background:url(/Images/bg1.gif) repeat-x;" CssClass="form-control" onblur="getstrKeys()" onkeyup="isgoEmpty('txtTitle','span_txtTitle');query('txtTitle','PYtitle')" runat="server" Text=''></asp:TextBox>
                    ...
                    <%--<tr>
			            ...
			            <td>
                            ...
                            <span style="color: #0000ff">
                                <input id="Button7" type="button" value="提取关键字" onclick="getstrKeys()" class="C_input" style="width: 110px;margin-left:8px;" />
                            </span>
			            </td>
		            </tr>--%>
                    <tr>
