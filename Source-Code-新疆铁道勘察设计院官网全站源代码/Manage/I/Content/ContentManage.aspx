<%@ page language="C#" autoeventwireup="true" inherits="Manage_I_Content_ContentManage, App_Web_qefxfnve" masterpagefile="~/Manage/I/Default.master" debug="true" enableEventValidation="false" viewStateEncryptionMode="Never" %>
...
<asp:Content runat="server" ContentPlaceHolderID="Content">
    <div style="width: 100%;">
        ...
        <table id="EGV" class="table table-striped table-bordered table-hover">
            <tr>
                <td><input type="checkbox" id='chkAll'/></td><td>ID</td><td>标题</td><td>录入者</td><td>点击数</td><td>推荐</td><td>状态</td><td>排序</td><td>操作</td>
            </tr>
