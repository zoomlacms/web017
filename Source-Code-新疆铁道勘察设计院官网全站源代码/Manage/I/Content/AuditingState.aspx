<%@ page language="C#" autoeventwireup="true" inherits="ZoomLa.WebSite.Manage.Content.AuditingState, App_Web_oo4sanix" enableviewstatemac="false" masterpagefile="~/Manage/I/Default.master" enableEventValidation="false" viewStateEncryptionMode="Never" %>
<asp:Content runat="server" ContentPlaceHolderID="head">
    <title>工作流配置</title>
</asp:Content>
<asp:Content runat="server" ContentPlaceHolderID="Content">
    <asp:GridView ID="EGV" runat="server" DataSourceID="odsAuditingState" AllowPaging="True" AutoGenerateColumns="False" DataKeyNames="stateCode" AllowSorting="True" 
        PageSize="20" OnRowCommand="gvAuditingState_RowCommand"   class="table table-striped table-bordered table-hover" >
	<Columns>
