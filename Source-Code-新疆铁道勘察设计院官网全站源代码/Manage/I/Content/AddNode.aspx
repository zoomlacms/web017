<%@ page language="C#" autoeventwireup="true" inherits="Manage_I_Content_AddNode, App_Web_qefxfnve" masterpagefile="~/Manage/I/Default.master" debug="true" enableEventValidation="false" viewStateEncryptionMode="Never" %>
            ...
            function EBtnS() {
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <asp:TextBox ID="TxtNodeName" class="form-control" style="max-width:200px;" runat="server" Columns="30" onkeyup="Getpy('TxtNodeName','TxtNodeDir')" OnTextChanged="TxtNodeName_TextChanged" AutoPostBack="True"></asp:TextBox>
