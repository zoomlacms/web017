<%@ page language="C#" autoeventwireup="true" inherits="Manage_I_Content_EditNode, App_Web_qefxfnve" masterpagefile="~/Manage/I/Default.master" debug="true" enableEventValidation="false" viewStateEncryptionMode="Never" %>
            ...
            <table width="100%" class="table table-striped table-bordered table-hover" cellpadding="2" cellspacing="1">
                ...
                <tbody>
                    <tr>
                        ...
                        <td>
                            <%--<asp:TextBox ID="TxtIndexTemplate" class="form-control"  MaxLength="255" runat="server" Columns="50"></asp:TextBox>--%>
                            <asp:DropDownList ID="TxtIndexTemplate" runat="server" CssClass=" form-control pull-left" Style="max-width: 300px;"></asp:DropDownList>
                    ...
                    <tr>
                        ...
                        <td>
                            <%--<asp:TextBox ID="TxtTemplate" class="form-control"  MaxLength="255" runat="server" Columns="50"></asp:TextBox>--%>
                            <asp:DropDownList ID="TxtTemplate" runat="server" CssClass=" form-control pull-left" Style="max-width: 300px;"></asp:DropDownList>
                    ...
                    <tr>
                        ...
                        <td>
                            <asp:DropDownList ID="LastinfoTemplate" runat="server" CssClass="form-control pull-left" Style="max-width: 300px;"></asp:DropDownList>
                            <%--<asp:TextBox ID="LastinfoTemplate" class="form-control"  MaxLength="255" runat="server" Columns="50"></asp:TextBox>--%>
                    ...
                    <tr>
                        ...
                        <td>
                            <asp:DropDownList ID="HotinfoTemplate" runat="server" CssClass=" form-control pull-left" Style="max-width: 300px;"></asp:DropDownList>
                    ...
                    <tr>
                        ...
                        <td>
                            <asp:DropDownList ID="ProposeTemplate" runat="server" CssClass=" form-control pull-left" Style="max-width: 300px;"></asp:DropDownList>
