<%@ page language="C#" autoeventwireup="true" inherits="V_Content_AddContent, App_Web_oo4sanix" masterpagefile="~/Manage/I/Default.master" clientidmode="Static" validaterequest="false" enableEventValidation="false" viewStateEncryptionMode="Never" %>
...
<asp:HiddenField ID="nodename" runat="server" />
            ...
            <div class="tab-pane active" id="ConInfo">
                <table id="mainTable" class="table table-bordered table_padding0">
                    ...
                    <tr>
                        ...
                        <td>
                            <asp:TextBox ID="PYtitle" CssClass="form-control pull-left" runat="server"></asp:TextBox>
                        </td>
                    </tr>
                    <tr runat="server" visible="false">
                        <td align="right"><asp:Label ID="gjz_txt" runat="server" Text="关键字"></asp:Label></td>
                        <td>
                            <asp:TextBox ID="TxtTagKey" CssClass="form-control pull-left" runat="server"></asp:TextBox>
                            <input type="button" name="FindKeyWord" id="FindKeyWord" class="btn btn-primary pull-left" onclick="getstrKeys()" value="提取关键字" />
                        </td>
                    </tr>
                    <tr runat="server">
    ...
    <div style="width: 100%; position: fixed; padding-top:10px; bottom: 0px; z-index: 1000; background: #fff; border-top: 3px solid #ddd;" class="text-center">
