<%@ page language="C#" autoeventwireup="true" inherits="test_test, App_Web_1ipbfo10" masterpagefile="~/Manage/I/Default.master" debug="true" enableEventValidation="false" viewStateEncryptionMode="Never" %>
...
<asp:Content runat="server" ContentPlaceHolderID="Content">
    ...
    <asp:GridView ID="Egv" runat="server" CssClass="table table-bordered table-hover table-striped"></asp:GridView>
</asp:Content>
