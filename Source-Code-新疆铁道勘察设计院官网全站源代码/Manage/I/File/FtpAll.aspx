<%@ page language="C#" autoeventwireup="true" inherits="manage_File_FtpAll, App_Web_peiyi1s4" enableviewstatemac="false" masterpagefile="~/Manage/I/Default.master" enableEventValidation="false" viewStateEncryptionMode="Never" %>

<asp:Content runat="server" ContentPlaceHolderID="head">
    <title>所有配置</title>
</asp:Content>
<asp:Content runat="server" ContentPlaceHolderID="Content">
    <asp:GridView ID="EGV" CssClass="table table-striped table-bordered table-hover" DataKeyNames="ID" runat="server"
