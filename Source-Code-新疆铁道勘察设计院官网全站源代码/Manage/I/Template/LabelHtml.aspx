<%@ page language="C#" autoeventwireup="true" inherits="ZoomLa.WebSite.Manage.I.Template.LabelHtml, App_Web_bzhz350p" masterpagefile="~/Manage/I/Default.master" validaterequest="false" enableEventValidation="false" viewStateEncryptionMode="Never" %>
            ...
            <td style="width: 100%; text-align: right;" colspan="2">
                <table style="width: 100%">
                    <tr>
                        ...
                        <td align="left">
                            <div id="Textarea">
                                <asp:TextBox TextMode="MultiLine" CssClass="form-control" runat="server" ID="textContent" Style="max-width: 100%; height: 435px;"></asp:TextBox>
                            </div>
                        </td>
                    </tr>
                </table>
