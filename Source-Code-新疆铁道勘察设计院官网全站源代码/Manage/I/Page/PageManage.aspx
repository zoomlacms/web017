<%@ page language="C#" autoeventwireup="true" inherits="manage_Page_PageManage, App_Web_d33h4pzc" enableviewstatemac="false" masterpagefile="~/Manage/I/Default.master" enableEventValidation="false" viewStateEncryptionMode="Never" %>
        ...
        <tr>
            <td>
                <span class="pull-left">按申请人地区筛选：
                    <select runat="server" id="selprovince" class="form-control" style="width:150px;" name="selprovince" onchange="javascript:area()">
                    </select>
