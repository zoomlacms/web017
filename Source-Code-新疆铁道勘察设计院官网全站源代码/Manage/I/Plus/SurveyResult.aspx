<%@ page language="C#" autoeventwireup="true" inherits="ZoomLa.WebSite.Manage.Plus.SurveyResult, App_Web_vamiqaqk" enableviewstatemac="false" masterpagefile="~/Manage/I/Default.master" enableEventValidation="false" viewStateEncryptionMode="Never" %>
        ...
        <tr>
            <td>
                <ul class="nav nav-tabs">
                    <li class="active"><a href="#Tabs1" data-toggle="tab">结果统计</a></li>
