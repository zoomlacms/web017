<%@ page language="C#" autoeventwireup="true" inherits="ZoomLa.WebSite.Manage.Plus.ADZone, App_Web_vamiqaqk" masterpagefile="~/Manage/I/Default.master" enableviewstatemac="false" enableEventValidation="false" viewStateEncryptionMode="Never" %>
                                ...
                                <table class="table table-striped table-bordered">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <img src="../../images/<%if (TxtMoveCloseFontColor.Text == "")
                                                                     {%>rectNoColor.gif<%}
                                                                     else
                                                                     {%>rect.gif<%} %>"
                                                width="18" height="17" border="0" id="MoveCloseFontColorShow" alt="选取颜色" style="cursor: pointer; background-color: #<%=TxtMoveCloseFontColor.Text %>;" title="选取颜色!" onclick="GetColor($('MoveCloseFontColorShow'),'TxtMoveCloseFontColor');" /></td>
                                    </tr>
                                </table>
                            </td>
                        </tr>
                                ...
                                <table class="table table-striped table-bordered">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <img src="../../images/<%if (TxtFixedCloseFontColor.Text == "")
                                                                     {%>rectNoColor.gif<%}
                                                                     else
                                                                     {%>rect.gif<%} %>"
                                ...
                                <table class="table table-striped table-bordered">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <img src="../../images/<%if (TxtFloatCloseFontColor.Text == "")
                                                                     {%>rectNoColor.gif<%}
                                                                     else
                                                                     {%>rect.gif<%} %>"
...
<asp:Content runat="server" ContentPlaceHolderID="ScriptContent">
    ...
    <script>
        ...
        {
            if ($("input[type=radio][id=radlZonetype_0]")[0].checked == false)
            {
                $("#RadlShowType_2").attr("disabled", "disabled");
            }
            else
            {
                $("#RadlShowType_2").attr("disabled", "");
            }
            Zone_DisableSize($("input[type=radio][id=radlZonetype_5]")[0].checked == true);
            for (var j = 0; j < 7; j++)
            {
                var ot = $("#ZoneTypeSetting" + (j + 1));//eval($('<%=ZoneTypeSetting.ClientID %>' + (j + 1)))
