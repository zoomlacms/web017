<%@ page language="C#" autoeventwireup="true" inherits="ZoomLa.WebSite.Manage.Plus.SurveyManage, App_Web_vamiqaqk" enableviewstatemac="false" masterpagefile="~/Manage/I/Default.master" enableEventValidation="false" viewStateEncryptionMode="Never" %>
...
<asp:Content runat="server" ContentPlaceHolderID="Content">
    ...
    <asp:GridView ID="EGV" RowStyle-HorizontalAlign="Center" DataKeyNames="Surveyid" CellPadding="2" CellSpacing="1" BackColor="White" CssClass="table table-striped table-bordered table-hover"
        GridLines="None" runat="server" AutoGenerateColumns="False" AllowPaging="True" PageSize="10" Width="100%" OnRowCommand="gviewSurvey_RowCommand" OnRowDataBound="gviewSurvey_RowDataBound" OnPageIndexChanging="gviewSurvey_PageIndexChanging">
