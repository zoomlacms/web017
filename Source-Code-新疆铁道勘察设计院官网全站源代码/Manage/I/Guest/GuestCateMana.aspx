<%@ page language="C#" masterpagefile="~/Manage/I/Default.master" autoeventwireup="true" inherits="Manage_I_Guest_GuestCateMana, App_Web_xcqpjaoy" validaterequest="false" enableviewstatemac="false" enableEventValidation="false" viewStateEncryptionMode="Never" %>
...
<div style="margin-bottom:10px;">
    <div>
		<span class="pull-left" style="line-height:34px"><%=lang.Get("M_GuestCateMana_categoryName")%>：</span><asp:TextBox ID="txtCateName" class="form-control pull-left" runat="server" Width="150px"></asp:TextBox>
...
<asp:GridView ID="Gdv" CssClass="table table-bordered table-hover table-striped" RowStyle-HorizontalAlign="Center" DataKeyNames="CateID" runat="server"
