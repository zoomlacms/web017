<%@ page language="C#" autoeventwireup="true" inherits="ZoomLa.WebSite.Manage.Plus.SurveyResult, App_Web_qzsya2tj" enableviewstatemac="false" debug="true" enableEventValidation="false" viewStateEncryptionMode="Never" %>
            ...
            <tr>
                <td>
                    <table width="100%" border="0" cellpadding="0" cellspacing="0">
                        <tr align="center">
                            <td id="TabTitle1" name="TabTitle1" class="titlemouseover" onclick="ShowTabs('Tabs1','TabTitle1')">结果统计
                            </td>
                            <td id="TabTitle2" name="TabTitle2" class="tabtitle" onclick="ShowTabs('Tabs2','TabTitle2')">详细信息
                            </td>
                            <td>&nbsp;
                            </td>
                        </tr>
